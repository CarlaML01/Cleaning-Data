...
treatments_clean.head(5) #worked!
...
id_names.given_name = id_names.given_name.str.lower() #lower case code
id_names.surname = id_names.surname.str.lower() #lower case code
